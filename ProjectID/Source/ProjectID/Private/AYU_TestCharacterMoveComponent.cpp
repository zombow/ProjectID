...
#include "ProjectID/TestCharacter.h"
...
void UAYU_TestCharacterMoveComponent::PlayerInputBinding(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction(TEXT("Interact"), IE_Pressed, this, &UAYU_TestCharacterMoveComponent::OnActionInteractPressed);
}
...
void UAYU_TestCharacterMoveComponent::OnActionInteractPressed()
{
